      ...
      <Element name="pricing">
        <div className="container">
          ...
          >
            ...
            <div
              className="relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-s4/25 bg-s1/50 p-2 backdrop-blue-[6px]
            max-md:w-[310px]"
            >
              <button
              ...
              <div
                className={clsx(
                  "g4 rounded-14 before:h-100 pricing-head_btn_before absolute left-2 top-2 " +
